...
//promise state variables : pending,completed,failed
//createAsyncThunk function automatically append promise state variables along with action
//name eg: users/fetchUsers/pending, users/fetchUsers/completed,users/fetchUsers/failed

//returns ThunkFunction , which is used to dispatch To store
